...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-introduce" class="form-control" name="row[introduce]" type="text" value="<?php echo htmlentities($row['introduce']); ?>">
        </div>
    </div>
    <div class="form-group">
