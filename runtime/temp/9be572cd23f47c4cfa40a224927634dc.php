                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <select name="row[type]" class="form-control selectpicker">
                                ...
                                <option value="<?php echo $key; ?>" {in name="key" value="string" }selected{
                                /in}><?php echo $vo; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <select name="row[group]" class="form-control selectpicker">
                                ...
                                <option value="<?php echo $key; ?>" {in name="key" value="basic" }selected{
                                /in}><?php echo $vo; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
